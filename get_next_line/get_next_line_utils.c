...
/*   Updated: 2024/10/21 19:06:36 by nbonnet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strcat(char	*updated_rest, char *rest, char *buf, int len)
{
	int	i;
	int	j;
...
char	*ft_find_line(char *rest)
{
	...
	if (!line)
		return (NULL);
	line = ft_strcat(line, NULL, rest, len);
	return (line);
}
...
char	*ft_find_rest(char *rest)
{
	...
	new_rest = ft_strcat(new_rest, NULL, start, len);
	free(rest);
	return (new_rest);
}
